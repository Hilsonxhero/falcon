    ...
    <div class="row">
        <div class="col-12">
            <div class="toolbar-ui">
                <h1 class="text-dark fs-5 fw-bold">ایجاد روش ارسال</h1>
                <ul class="breadcrumb-ui ps-0">
                    <li><a href="{{ route('admin.dashboard') }}" title="">پیشخوان</a></li>
                    <li><a href="{{ route('admin.shipments.index') }}" title="">روش های ارسال</a></li>
                    <li><a href="" title="">ایجاد روش ارسال</a></li>
                </ul>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="عنوان "
                                        wire:model.lazy="shipment.title">
                                </div>
                            </div>
                        </div>

                        <div class="form-group">
                            <textarea class="form-control" wire:model.lazy="shipment.description"></textarea>
                        </div>
                                        ...
                                        <div class="">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox"
                                                    wire:model.lazy="shipment.status" id="flexSwitchCheckDefault">
