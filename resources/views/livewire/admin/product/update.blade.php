                ...
                <div class="body">
                    <form wire:submit.prevent="update" id="form" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-3" wire:key="UNIQUE_KEY">
                                <div class="form-group" wire:ignore>
                                    <select class="js-select-ui form-select" wire:model.lazy="product.category_id"
                                        name="category_id" data-bind="product.category_id" id="category">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" wire:ignore>
                                    <select class="js-select-ui form-select" wire:model.lazy="product.guarantee_id"
                                        data-bind="product.guarantee_id">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" wire:ignore>
                                    <select class="js-select-ui form-select" wire:model.lazy="product.brand_id"
                                        data-bind="product.brand_id">
                            ...
                            <div class="col-md-3">
                                <div class="form-group" wire:ignore>
                                    <select class="js-select-ui form-select" wire:model.lazy="product.shipment_id"
                                        data-bind="product.shipment_id">
                            ...
                            <div class="col-md-12">
                                <div class="form-group file-upload-ui">
                                    ...
                                    <div class="preview">
                                        @if ($product->banner)
                                            <img id="file-ip-1-preview" src="{{ $product->banner->thumb() }}">

                                        @else
                                            <img id="file-ip-1-preview" src="{{ $banner->temporaryUrl() }}">
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group" wire:ignore>
                            ...
                            <textarea class="form-control editor" style="height: 200px" wire:model="product.body"
                                name="body" id="body">{!! $product->body !!}</textarea>
                        </div>
